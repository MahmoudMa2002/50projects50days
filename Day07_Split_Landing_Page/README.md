# Split Landing Page - Interactive Showcase
...
## Info
**Tech:** HTML, CSS (Custom Properties, Pseudo-elements), JavaScript  
**Focus:** Hover interactions, responsive design  
...
- Hover state management across multiple elements
- CSS pseudo-elements (::before) for overlay effects
- Responsive design for different screen sizes


## Links
[View Project](https://codepen.io/MahmoudMa2002/full/azOwEVz) | [Back to Main Projects List](../README.md)