...
## Info
**Tech:** HTML, CSS (Custom Properties, Animations), JavaScript, Axios, GitHub API  
**Focus:** API integration, async/await, error handling, dynamic DOM manipulation  
...
- Smooth animations and transitions including fade-in effects
...
## What I Learned
- API integration using Axios library with async/await patterns
- Error handling with try-catch blocks and specific status code responses
- Dynamic DOM manipulation based on API responses
- Managing multiple asynchronous operations for user data and repositories
- Form handling with preventDefault for custom functionality
- Array methods (slice, forEach) for limiting and displaying data


## Links
[View Project](https://codepen.io/MahmoudMa2002/full/dPoReBR) | [Back to Main Projects List](../README.md)